package org.openconnect.oauth2.client.demo.controller;
...
public class DemoController {
    ...
    @GetMapping("/remoteCall2")
    public String remoteCall2() {
        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://localhost:8081/user", String.class);
        return responseEntity.getBody();
    }
}
